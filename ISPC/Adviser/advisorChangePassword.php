...
<?php
	...
	if(isset($_POST['changePassword'])){
        ...
        $user_check_query = "SELECT * FROM advisorinfo WHERE UserName = '$userName' LIMIT 1";
         ...
         if(count($errors) == 0){
			...
			$sql = "UPDATE advisorinfo set Password = '$password' where UserName = '$userName'";
			mysqli_query($db, $sql);
            ...
            <div class = "col-md-10 offset = md - 1">
                <div class = "row">
                    ...
                    <?php  if (isset($_SESSION['userName'])) : ?>
                       <p>Welcome user, <strong><?php echo $_SESSION['userName']; ?></strong></p>
                         <!-- main part------------------------------------------------ -->
                            ...
                            <!-- logout -->
                            <a href="advisorLogin.php?logout='1'" style="color: red;"><button type = "button" class = "btn btn-primary" >Logout</button></a>
                    <?php endif ?>
		</div>
                        <br>
                    ...
                    <div class = "col-md-7 register-right">
                        <br><br><br>
                        <form method = "post" action = "advisorChangePassword.php">
                            <!-- display errors -->
