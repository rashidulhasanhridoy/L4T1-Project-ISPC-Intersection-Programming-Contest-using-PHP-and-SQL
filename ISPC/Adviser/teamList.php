            ...
            <div class = "col-md-10 offset = md - 1">
                <div class = "row">
                    ...
                    <div class = "col-md-7 register-right">
                        ...
                        $sql = "SELECT TeamID, Member1, TeamName, ID1, UserName1, Member2, ID2, UserName2, Batch, Section FROM team where 
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "No team added in database!";
                        }
