<?php
	...
	if(isset($_POST['signUp'])){
		...
		if(count($errors) == 0){
			...
			$sql = "INSERT INTO advisorinfo(JoinDate, ID, UserName, Name, Gender, Email, PhoneNumber, Password, Request) VALUES('$joinDate', '$id', '$userName', '$name', '$gender', '$email', '$phoneNumber', '$password', '0')";
			...
			header('location: advisorLogin.php'); // redirect to homepage
...
<html>
<head>
    <title>ISPC | Advisor Sign Up</title>
            ...
            <div class = "col-md-10 offset = md - 1">
                <div class = "row">
                    <div class = "col-md-5 register-left">
                       ...
                       <a href = "advisorLogin.php"><button type = "button" class = "btn btn-primary" >Login</button></a>
                        <br><br>
                    ...
                    <div class = "col-md-7 register-right">
                        ...
                        <form method = "post" action = "advisorRegistration.php">
                        <!-- display errors -->
