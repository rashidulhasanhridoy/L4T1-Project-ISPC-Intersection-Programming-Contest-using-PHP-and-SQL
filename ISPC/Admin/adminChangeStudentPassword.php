...
<html>
<head>
    <title>ISPC | Change Student Password</title>
            ...
            <div class = "col-md-10 offset = md - 1">
                <div class = "row">
                    ...
                    <div class = "col-md-7 register-right">
                        <br><br><br>
                        <form method = "post" action = "adminChangeStudentPassword.php">
                        ...
                        <div class = "register-form" >
                            ...
                            <button type = "submit" class = "btn btn-primary" name  = "changePassword" onclick="">Update</button>
                        </div>
                        </form>
                    </div> 
                </div>
