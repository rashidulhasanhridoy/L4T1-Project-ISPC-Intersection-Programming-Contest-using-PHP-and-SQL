<?php
	...
	if(isset($_POST['select'])){
        ...
        $sql = "SELECT Name, UserName from advisorinfo where ID = '$sID'";
...
<html>
<head>
    <title>ISPC | Change Advisor Password</title>
            ...
            <div class = "col-md-10 offset = md - 1">
                <div class = "row">
                    ...
                    <div class = "col-md-7 register-right">
                        <br><br><br>
                        <form method = "post" action = "adminChangeAdvisorPassword.php">
