<?php
	...
	if(isset($_POST['signUp'])){
		...
		if(count($errors) == 0){
			...
			$sql = "INSERT INTO admininfo(JoinDate, ID, UserName, Name, Gender, Email, PhoneNumber, Password, Request) VALUES('$joinDate', '$id', '$userName', '$name', '$gender', '$email', '$phoneNumber', '$password', '0')";
...
<html>
<head>
    <title>ISPC | Admin Sign Up</title>
