<?php
	...
	if(isset($_POST['select'])){
        ...
        $sql = "SELECT Name, UserName, Gender, Email, PhoneNumber from advisorinfo where ID = '$sID'";
...
<?php
	...
	if(isset($_POST['updateProfile'])){
		...
		if(count($errors) == 0){
			$sql = "UPDATE advisorinfo set Name = '$name', Gender = '$gender', PhoneNumber = '$phoneNumber', Email = '$email' WHERE UserName = '$userName'";
			mysqli_query($db, $sql);
            echo "updated!";
...
<html>
<head>
    <title>ISPC | Update Advisor Profile</title>
            ...
            <div class = "col-md-10 offset = md - 1">
                <div class = "row">
                    ...
                    <div class = "col-md-7 register-right">
                        <br><br><br>
                        <form method = "post" action = "adminUpdateAdvisorProfile.php">
						 ...
						 <?php
							...
							if(count($errors) == 0){
                            $query = "Select distinct ID From advisorinfo";
