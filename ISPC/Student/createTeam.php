...
<?php
	...
	if(isset($_POST['createTeam'])){
		...
		if(count($errors) == 0){
			$_SESSION['member1'] = $userName11;
			$_SESSION['member2'] = $userName2;
			$_SESSION['teamName'] = $teamName;
            header('location: TeamConfirm.php');
		}
                    ...
                    <div class = "col-md-7 register-right">
                        ...
                        <form method = "post" action = "createTeam.php">
						 ...
						 <?php
							...
							Section = (Select Section from studentinfo where UserName = '$userName') 
							AND Batch = (Select Batch from studentinfo where UserName = '$userName') 
							AND Request = '1'
