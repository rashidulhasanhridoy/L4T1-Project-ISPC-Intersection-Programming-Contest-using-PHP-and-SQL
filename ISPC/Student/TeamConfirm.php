...
<?php
	...
	if(isset($_POST['createTeam'])){
		...
		if(count($errors) == 0){
			...
			VALUES('$teamName', '$teamID', '$name1', '$id1', '$userName1', '$name2', '$id2', '$userName2', '$batch', '$section', '$date', '0', '0')";
            ...
            <div class = "col-md-10 offset = md - 1">
                <div class = "row">
                    ...
                    <?php endif ?>
                        ...
                        <a href="createTeam.php"><button type = "button" class = "btn btn-primary" >Back</button></a>
                        
                        
                    </div>
                    <div class = "col-md-7 register-right">
                        <br><br><br>
                        <form method = "post" action = "TeamConfirm.php">
